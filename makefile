...
vf3: network_model.cpp my_vectfit_non.cpp my_vectfit_all.cpp my_vectfit_column.cpp vf3_main.cpp
	icpc -g0 -Ofast $(INCLUDES) $(LIBS) vf3_main.cpp my_vectfit_non.cpp my_vectfit_all.cpp my_vectfit_column.cpp network_model.cpp -ovf3 $(LDFLAGS)
